...
class PluginRegistry {
    ...
    public static final XnatPlugin CONTAINER_SERVICE = new XnatPlugin(CS_PLUGIN_ID, 'containers', 'org.nrg', 'containers', 'https://bitbucket.org/xnatdev/container-service')
